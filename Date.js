  ...
  formatTimestamp: function (stamp, type) {
    ...
    switch (type) {
      ...
      case 'ymdhm':
        ...
        break;
      case 'ymdhmzh':
        result = '' + stdDate.year + '年' + parseInt(stdDate.month, 10) + '月' + parseInt(stdDate.day, 10) + '日 ' + stdDate.hour + ':' + stdDate.minute;
        break;
      case 'mdhmzh':
        result = '' + parseInt(stdDate.month, 10) + '月' + parseInt(stdDate.day, 10) + '日 ' + stdDate.hour + ':' + stdDate.minute;
        break;
      default:
        result = '' + stdDate.month + '-' + stdDate.day + ' ' + stdDate.hour + ':' + stdDate.minute;
        break;
